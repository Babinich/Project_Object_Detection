...
parser.add_argument('--dataset_path', required=False, default= './datasets/coco_dataset/annotations_coco.json', help='Path to annotations')
args = parser.parse_args()

# New output directory for saving images
output_dir = './datasets/yolo_dataset/images'
